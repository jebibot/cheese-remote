      ...
      <div className="flex items-center justify-end bg-emerald-500 dark:bg-emerald-600">
        ...
        >
          <Tooltip label="설정">
            <div>
              <PopoverTrigger>
                <button className="p-3 m-2 rounded-md text-gray-200 hover:bg-emerald-400 dark:hover:bg-emerald-500">
          ...
          <PopoverContent>
            ...
            <PopoverBody>
              <div className="flex flex-col gap-2 text-gray-800">
                <div>
                  <div className="mb-1 font-semibold">TTS 볼륨</div>
                  <Slider
                    min={0}
                    max={1}
                    scale={100}
                ...
                <div>
                  <div className="mb-1 font-semibold">알림 노출 시간 조절</div>
                  <Slider
                    min={-5000}
                    max={5000}
                    scale={0.01}
